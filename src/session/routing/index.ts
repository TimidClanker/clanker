...
Use each session's last user message and last assistant response to recognize follow-up answers and requests. A session may still be working on its last user message; clear continuations can steer that work even before its first assistant response.
